...
3027|Server is busy. Please try after sometime|Yes|	Status check|Do a status check to see if the transaction reached TerraPay. Contact TerraPay technical team if the same error code persists
